...
const Banner = () => {
  return (
    <div className="max-w-7xl container mx-auto p-5 md:p-0">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-between md:gap-10 pt-10 flex-row-reverse ">
        {/* Left Side */}
        <div>
          <p className="text-lg font-medium underline underline-offset-8 decoration-red-500 decoration-4 my-5">
            Welcome!
          </p>
          <h1 className="text-6xl font-bold font-poppins leading-snug capitalize">
